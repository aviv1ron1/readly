...
Constructor receives filename and optional encoding (default is utf8) and EOL (end of line, default is OS newline char) character
throws an error if filename is not a file or does not exist
```
